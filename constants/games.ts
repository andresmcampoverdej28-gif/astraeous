...
export const GAMES: GameData[] = [
  ...
  },
  {
    ...
    description:
      'Un popular juego de terror y supervivencia en primera persona dentro de Roblox, desarrollado por LSPLASH. Los jugadores deben explorar un hotel embrujado, atravesando habitaciones y abriendo puertas (hasta la 100 o más).\n\nMientras evaden "entidades" (monstruos) que intentan eliminarlos, utilizan objetos de ayuda como linternas y ganzúas para sobrevivir.',
  },
];
